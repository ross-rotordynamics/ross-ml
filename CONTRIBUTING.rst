...
How to contribute to ROSS-ML using git
--------------------------------------
.. _git-configuration:
...
Step 1: Make your copy (fork) of ROSS-ML
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
Go to https://github.com/ross-rotordynamics/ross-ml
In the top-right corner of the page, click Fork, to fork it to your GitHub account.

From the command line::

    git clone https://github.com/your-user-name/ross-ml.git
    cd ross-ml
    git remote add upstream https://github.com/ross-rotordynamics/ross-ml.git

Step 2: Keep in sync with changes in ROSS-ML
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
It should look like this::
    ...
    [remote "origin"]
            url = https://github.com/your-user-name/ross-ml.git
            fetch = +refs/heads/*:refs/remotes/origin/*
    [remote "upstream"]
            url = https://github.com/ross-rotordynamics/ross-ml.git
